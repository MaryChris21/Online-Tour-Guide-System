        ...
        <div class="row">
            <div class="column">
                <a href="ProductForm.jsp" class="package gold">
                    ...
                    <div class="details">
                        ...
                        <strong>Destinations:</strong> Rome, Venice, Florence, Milan<br>
            ...
            <div class="column">
                <a href="ProductForm.jsp" class="package silver">
                    ...
                    <div class="details">
                        <strong>Enchanting Italy Adventure</strong><br>
                        <strong>Duration:</strong> 10 Days / 9 Nights<br>
                        <strong>Destinations:</strong> Tuscany, Cinque Terre, Sicily<br>
                        <strong>Inclusions:</strong>
                        <ul>
            ...
            <div class="column">
                <a href="ProductForm.jsp" class="package bronze">
                    ...
                    <div class="details">
                        <strong>Classic Italy Road Trip</strong><br>
                        <strong>Duration:</strong> 7 Days / 6 Nights<br>
                        <strong>Destinations:</strong> Sardinia, Lake District<br>
                        <strong>Inclusions:</strong>
                        <ul>
